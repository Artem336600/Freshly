...
def fetch_product_info(product_name, category):
    ...
    try:
        ...
        if not link:
            print(f"Не найдена ссылка на Яндекс Лавку для '{product_name}'")
            return {
                "name": product_name,
                "category": category,
...
if __name__ == "__main__":
    print("Локальный сервер запускается на http://localhost:5000")
